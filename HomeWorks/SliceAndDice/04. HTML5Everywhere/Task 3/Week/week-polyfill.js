...
(function () {
    ...
    (function ($) {
        $.fn.inputWeek = function () {
            var advanceWeek, compareWeeks, dateIsInStep, decrement, distanceBetweenWeeks, getFirstDayOfWeek, getLastDayOfWeek, getThursdayOfSameWeek, getThursdayOfWeek, getWeekOfDate, increment, makeWeekDisplayString, makeWeekString, readWeek, regressWeek, stepNormalize;
            readWeek = function (w_str) {
                var matchData, weekPart, yearPart;
            ...
            makeWeekString = function (week_obj) {
                var w_arr;
            ...
            makeWeekDisplayString = function (week_obj, elem) {
                var $elem, end_date, month_names, start_date, week_arr;
                $elem = $(elem);
            ...
            getThursdayOfSameWeek = function (dateObj) {
                var thursOfWeek;
            ...
            getWeekOfDate = function (dateObj) {
                var thursOfWeek;
                thursOfWeek = getThursdayOfSameWeek(dateObj);
                return {
                    year: thursOfWeek.getFullYear(),
                    week: $.datepicker.iso8601Week(thursOfWeek)
                };
            };
            getFirstDayOfWeek = function (week_obj) {
                var kDate;
            ...
            getLastDayOfWeek = function (week_obj) {
                var kDate;
                if (week_obj['week'] > 0 && week_obj['week'] <= 53) {
                    kDate = getThursdayOfSameWeek(new Date(week_obj['year'], 0, 1));
            ...
            getThursdayOfWeek = function (week_obj) {
                var kDate;
                if (week_obj['week'] > 0 && week_obj['week'] <= 53) {
                    kDate = getThursdayOfSameWeek(new Date(week_obj['year'], 0, 1));
            ...
            compareWeeks = function (week1, week2) {
            ...
            distanceBetweenWeeks = function (week1, week2) {
                var week1day, week2day;
            ...
            dateIsInStep = function (date, min, step) {
                var startWeek, weekDist, weekObj;
                weekObj = getWeekOfDate(date);
                startWeek = (min != null) ? min : {
                    year: 1970,
                    week: 1
                };
            ...
            advanceWeek = function (inWeek, amt) {
                var thursday;
                thursday = getThursdayOfWeek(inWeek);
                thursday.setDate(thursday.getDate() + (amt * 7));
                return {
                    year: thursday.getFullYear(),
                    week: $.datepicker.iso8601Week(thursday)
                };
            };
            regressWeek = function (inWeek, amt) {
                var thursday;
                thursday = getThursdayOfWeek(inWeek);
                thursday.setDate(thursday.getDate() - (amt * 7));
                return {
            ...
            increment = function (hiddenField, weekBtn, calendarDiv) {
                ...
                if ((max != null) && compareWeeks(value, max) === -1) {
                    value['year'] = max['year'];
                    value['week'] = max['week'];
                }
            ...
            decrement = function (hiddenField, weekBtn, calendarDiv) {
                ...
                if ((min != null) && compareWeeks(value, min) === 1) {
                    value['year'] = min['year'];
                    value['week'] = min['week'];
                }
                value = stepNormalize(value, hiddenField);
            ...
            stepNormalize = function (inWeek, hiddenField) {
                var $hiddenField, min, step, stepDiff, stepDiff2;
                $hiddenField = $(hiddenField);
                step = $hiddenField.data("step");
                min = $hiddenField.data("min");
                if ((step != null) && step !== 'any') {
                    stepDiff = distanceBetweenWeeks((min != null ? min : {
                        year: 1970,
                        week: 1
                    }), inWeek) % step;
                    if (stepDiff === 0) {
            ...
            $(this).filter('input[type="week"]').each(function () {
                var $calendarContainer, $calendarDiv, $hiddenField, $this, $weekBtn, calendarContainer, calendarDiv, className, closeFunc, hiddenField, max, min, step, style, value, weekBtn;
                $this = $(this);
                ...
                if ((value != null) && /^\d{4,}-W\d\d$/.test(value)) {
                    value = readWeek(value);
                } else {
                    value = new Date();
                    value = {
                        year: value.getFullYear(),
                        week: $.datepicker.iso8601Week(value)
                    };
                }
                if (min != null) {
                    min = readWeek(min);
                ...
                $weekBtn.text(makeWeekDisplayString(value, calendarDiv));
                if (min != null) {
                    $calendarDiv.datepicker("option", "minDate", getFirstDayOfWeek(min));
                }
                if (max != null) {
                    $calendarDiv.datepicker("option", "maxDate", getLastDayOfWeek(max));
                }
